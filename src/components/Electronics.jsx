...
const Electronics = () => {
  ...
  return (
    <div className={`p-6 md:top-[10rem] top-[4rem] xl:top-[10rem] relative xl:mb-[10rem] mb-[4rem] md:mb-[10rem] min-h-[20rem] ${mode === 'light' ? 'bg-gray-100' : 'bg-gray-900'}`}>
        ...
        {products.map(item => (
          ...
          >
            ...
            <button 
                ...
                className={`px-5 py-2 rounded-sm relative top-2
                  text-white md:text-sm font-semibold 
                  shadow-md transition-all duration-200 
                  ease-in-out flex items-center mx-auto
                  ${mode === 'light' ? 'bg-orange-400 hover:bg-orange-500' 
